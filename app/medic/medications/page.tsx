...
export default async function MedicMedicationPage({ searchParams }: { searchParams: Promise<{ site?: string }> }) {
  const resolvedSearchParams = await searchParams
  const data = await getMedicDashboardData('medication')
