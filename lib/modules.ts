...
export const MODULE_REGISTRY: Record<ModuleKey, ModuleRegistryEntry> = {
  ...
  fatigue_assessment: {
    ...
    description: 'Fatigue screening and medic review workflow now seeded on the module engine.',
    category: 'custom',
    icon: 'moon-star',
    ...
    canActivate: false,
    statusNote: 'Database foundation is ready, but worker and medic screens are not shipped yet.',
  },
  fit_for_work_plus: {
